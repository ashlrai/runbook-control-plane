 ...
 * 1 discovery + 6 ledger + 7 offline + 6 shadow + 13 session + 11 elite = 45 tools.
...
export const MCP_TOOLS: readonly McpToolRow[] = [
  ...
  },
  {
    ...
    effect: "Check-by-check ledger vs session charter theater",
    assurance: "process-layer-not-capital-risk-grade",
    lane: "elite",
    readOnly: true,
  },
  {
  ...
  },
  {
    ...
    effect: "List process_tick ring buffer (last 64)",
    assurance: "local-session-only",
    lane: "elite",
    readOnly: true,
  },
  {
    ...
    effect: "Closed curriculum + operator scenarios → HFA/HFD",
    assurance: "synthetic-curriculum-process-quality-only",
    lane: "elite",
    readOnly: true,
  },
  {
    ...
    effect: "Multi-axis process health (ticks + shadow HFA)",
    assurance: "process-observation-not-composite-grade",
    lane: "elite",
    readOnly: true,
  },
] as const;
...
export const MCP_SERVER_VERSION = "0.4.5" as const;
