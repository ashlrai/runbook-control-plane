...
| **MCP** | `runbook` **v0.4.1** · closed **39-tool** inventory · `brokerExecutionTools: []` |
...
```text
                         ...
                         └──────────────┬──────────────┘
                                        ...
                                        ▼
┌──────────────────────────────────────────────────────────────────┐
│  @runbook/mcp  (runbook v0.4.1 · 39 tools · openWorldHint:false) │
...
| Tools | **39** closed names in `TOOL_NAMES` |
