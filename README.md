...
| **MCP** | `runbook` **v0.4.2** · closed **40-tool** inventory · `brokerExecutionTools: []` |
...
```text
                         ...
                         └──────────────┬──────────────┘
                                        ...
                                        ▼
┌──────────────────────────────────────────────────────────────────┐
│  @runbook/mcp  (runbook v0.4.2 · 40 tools · openWorldHint:false) │
...
| Tools | **40** closed names in `TOOL_NAMES` |
