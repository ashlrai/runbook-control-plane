...
| **MCP** | `runbook` **v0.4.3** · closed **42-tool** inventory · `brokerExecutionTools: []` |
...
```text
                         ...
                         └──────────────┬──────────────┘
                                        ...
                                        ▼
┌──────────────────────────────────────────────────────────────────┐
│  @runbook/mcp  (runbook v0.4.3 · 42 tools · openWorldHint:false) │
...
| Tools | **42** closed names in `TOOL_NAMES` |
